...
import { PropertyCardSkeleton, BlogCardSkeleton } from "@/components/ui/Skeleton";
import {
  Search, Home, Building2, MapPin, Star, Phone,
  CheckCircle, TrendingUp, Users, Award, Shield,
} from "lucide-react";
    ...
    <div className="min-h-screen bg-gray-50">
            ...
            <div className="bg-white rounded-2xl shadow-2xl p-4">
              ...
              <div className="flex flex-col md:flex-row gap-3">
                <div className="flex-1 flex items-center gap-2 border rounded-lg px-3 py-2">
                  ...
                  <input type="text" placeholder="Search by area, city, or property type..."
                    className="flex-1 outline-none text-gray-700 text-sm" value={location}
                ...
                <Link href={`/properties${searchType !== "all" ? `?type=${searchType}` : ""}${location ? `&location=${location}` : ""}`}
      ...
      <section className="py-20 max-w-7xl mx-auto px-4">
        <div className="text-center mb-12">
          ...
          <p className="text-slate-500 mt-3 max-w-xl mx-auto">
            Explore our handpicked selection of premium properties across Pakistan's top cities.
          </p>
        </div>
      ...
      <section className="py-24 relative"
        ...
        <div className="relative z-10 max-w-3xl mx-auto px-4 text-center">
          ...
          <p className="text-slate-300 mb-8 text-lg">Get a free consultation with our real estate experts today.</p>
