  ...
  const handleSave = async () => {
    ...
    try {
      await api.post("/api/agents", {
        ...
        image:
          image ||
          `https://ui-avatars.com/api/?name=${encodeURIComponent(form.name)}&background=1a2e5a&color=fff&size=400`,
        properties: 0,
      });
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 space-y-5">
          <div className="bg-white rounded-xl shadow-sm p-6 space-y-4">
            <h3 className="font-bold text-[#1a2e5a] border-b pb-2">
              Agent Information
            </h3>
            <Field
              label="Full Name"
        ...
        <div className="space-y-5">
          <div className="bg-white rounded-xl shadow-sm p-6">
            <h3 className="font-bold text-[#1a2e5a] border-b pb-2 mb-4">
              Agent Photo
            </h3>
            ...
            <p className="text-xs text-slate-400 mt-3">
              If no photo uploaded, a placeholder avatar will be generated
              automatically.
            </p>
          </div>
          ...
          <div className="bg-white rounded-xl shadow-sm p-6">
            ...
            <p className="text-xs text-slate-400 mt-2">
              Active agents appear on the public agents page.
            </p>
          </div>
        </div>
      </div>
