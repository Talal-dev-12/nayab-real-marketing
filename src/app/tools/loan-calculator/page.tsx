    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-4xl mx-auto px-4 py-12">
        <div className="text-center mb-8">
          <span className="inline-block bg-emerald-100 text-emerald-600 text-xs font-bold px-3 py-1 rounded-full mb-3 uppercase tracking-wide">Free Tool</span>
          <h1 className="text-3xl font-extrabold text-[#1a2e5a]">Home Loan Calculator</h1>
          <p className="text-slate-500 mt-2">Calculate your monthly EMI for home loans in Pakistan</p>
        </div>
