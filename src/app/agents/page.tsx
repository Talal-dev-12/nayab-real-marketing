...
export default function AgentsPage() {
  ...
  const specializations = [
    "all",
    ...Array.from(new Set(agents.map((a) => a.specialization))),
  ];
  const filtered = agents.filter((a) => {
    ...
    const matchSpec =
      specialization === "all" || a.specialization === specialization;
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="bg-gradient-to-br from-[#0f1e3d] to-[#1a2e5a] py-20 text-center relative overflow-hidden">
        <div className="relative">
          <span className="inline-block bg-red-700/20 text-red-400 text-xs font-bold px-4 py-1.5 rounded-full uppercase tracking-widest mb-4">
            Our Team
          </span>
          ...
          <p className="text-slate-400 text-lg max-w-2xl mx-auto">
            Trusted real estate professionals with deep knowledge of Pakistan's
            property market
          </p>
          <div className="flex justify-center gap-12 mt-10">
            {[
              ...
              {
                value: `${agents.reduce((s, a) => s + a.properties, 0)}+`,
              ...
              >
                <div className="h-28 bg-gradient-to-br from-[#0f1e3d] to-[#1a2e5a] relative">
                  ...
                  <Image
                    ...
                    width={96}
                    height={96}
                    className="absolute bottom-0 left-6 translate-y-1/2 w-24 h-24 rounded-full border-4 border-white object-cover shadow-lg"
                  />
                </div>
                <div className="px-6 pb-6 pt-16">
                  ...
                  <h3 className="text-xl font-extrabold text-[#1a2e5a] mb-0.5">
                    {agent.name}
                  </h3>
                  ...
                  <div className="flex items-center gap-4 bg-slate-50 rounded-xl p-3 mb-5">
                    ...
                    <div className="text-center flex-1">
                      <span className="text-xl font-extrabold text-[#1a2e5a]">
                        10+
                      </span>
                  ...
                  <div className="space-y-2">
                    <a
                      ...
                      className="flex items-center gap-3 w-full bg-red-700 hover:bg-red-600 text-white px-4 py-3 rounded-xl text-sm font-semibold transition-colors"
                    >
                      <Phone size={15} /> {agent.phone}
                    </a>
                    <a
                      href={`mailto:${agent.email}`}
                      className="flex items-center gap-3 w-full bg-slate-100 hover:bg-slate-200 text-slate-700 px-4 py-3 rounded-xl text-sm font-semibold transition-colors"
                    >
