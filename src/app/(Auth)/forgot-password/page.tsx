...
export default function ForgotPasswordPage() {
  ...
  return (
    <div className="min-h-screen bg-[#f4f7f6] flex items-center justify-center p-4 sm:p-8 font-sans">
      <div className="bg-white rounded-2xl shadow-2xl w-full max-w-[900px] lg:max-w-[1000px] flex overflow-hidden lg:min-h-[550px] border border-white/50 relative">

        {/* Subtle background glow effect */}
        <div className="absolute top-[-20%] left-[-10%] w-[50%] h-[50%] bg-blue-100/50 rounded-full blur-3xl pointer-events-none" />

        {/* LEFT PANEL */}
        <div className="w-full lg:w-[45%] p-6 sm:p-8 md:p-10 flex flex-col justify-center bg-white relative shrink-0 z-10">
          {/* Logo element matched to theme */}
          <Link href="/" className="inline-flex flex-row items-center gap-2 mb-4 group self-start">
            <div className="w-10 h-10 bg-gradient-to-br from-red-700 to-red-500 rounded-2xl flex items-center justify-center shadow-lg shadow-red-500/30 group-hover:shadow-red-500/50 transition-all duration-300 transform group-hover:-translate-y-1">
              <Home size={20} className="text-white" />
            </div>
            <div className="flex flex-col">
              <span className="font-extrabold text-[1.05rem] leading-none tracking-tight text-[#1a2e5a]">NAYAB</span>
          ...
          {success ? (
            <div className="text-left py-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
              <div className="w-20 h-20 bg-gradient-to-br from-emerald-400 to-emerald-600 rounded-2xl flex items-center justify-center mb-5 shadow-lg shadow-emerald-500/30">
                <Send size={32} className="text-white ml-[-2px] mt-[2px]" />
              </div>
              <h2 className="text-2xl font-extrabold text-[#1a2e5a] mb-3 tracking-tight leading-tight">Check your inbox!</h2>
            ...
            <div className="animate-in fade-in slide-in-from-bottom-4 duration-500">
              <h1 className="text-3xl font-extrabold text-[#1a2e5a] mb-2 tracking-tight leading-tight">Forgot Password?</h1>
              <p className="text-slate-500 text-sm font-medium mb-4 leading-relaxed">
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                <div className="relative group">
                  ...
                  <input
                    ...
                    className="w-full pl-11 pr-4 py-2 bg-slate-50 border-2 border-slate-100 rounded-xl outline-none text-[#1a2e5a] text-sm font-medium placeholder:text-slate-400 focus:border-red-500 focus:bg-white transition-all shadow-sm"
                    placeholder="Enter your email address"
                  />
                </div>

                {error && (
                  <div className="bg-red-50 border border-red-100 text-red-700 text-xs px-4 py-2 rounded-xl flex items-start gap-2 animate-in fade-in zoom-in-95">
                ...
                <button
                  ...
                  className="w-full bg-gradient-to-r from-[#1a2e5a] to-[#2a447a] hover:from-[#112040] hover:to-[#1a2e5a] disabled:opacity-70 disabled:cursor-not-allowed text-white py-2 rounded-xl font-bold text-sm transition-all duration-300 shadow-lg shadow-blue-900/20 flex items-center justify-center gap-2 transform hover:-translate-y-0.5"
                >
                  {loading ? (
          ...
          <div className="mt-auto pt-10 text-left">
            <Link href="/sign-in" className="inline-flex items-center gap-2 text-xs font-bold text-slate-400 hover:text-[#1a2e5a] transition-colors group">
        ...
        <div className="hidden lg:block w-[55%] relative lg:h-[550px] self-center p-4">
