        ...
        <div className="hidden lg:block w-[55%] relative p-4 pl-0 py-5 pr-5">
          <div className="w-full h-full bg-slate-200 rounded-[2.5rem] rounded-tl-[10rem] rounded-br-[10rem] overflow-hidden relative shadow-[inset_0_0_20px_rgba(0,0,0,0.05)]">
            <div className="absolute top-12 right-12 max-w-[340px] text-right z-10 w-full flex flex-col items-end">
              <h2 className="text-[#1a2e5a] text-[28px] font-extrabold leading-[1.2] mb-6 inline-block">
                Ready to manage your real estate portfolio?
              </h2>
              <ul className="space-y-4 inline-block text-left bg-white/70 backdrop-blur-sm p-6 rounded-2xl border border-white/50 shadow-sm relative">
                {BENEFITS.map(b => (
                  <li key={b} className="flex items-center gap-3 text-sm">
                    <CheckCircle2 size={18} className="text-red-700 shrink-0" />
                    <span className="text-[#1a2e5a] font-bold text-[15px]">{b}</span>
                  </li>
                ))}
              </ul>
            </div>
