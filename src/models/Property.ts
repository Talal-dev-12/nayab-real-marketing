...
export interface IProperty extends Document {
  ...
  featured:     boolean;
  agentId:      string;
  /** ID of the AdminUser/User who submitted this property (seller tracking) */
  submittedBy?: string;
  views:        number;
  createdAt:    Date;
  updatedAt:    Date;
...
const PropertySchema = new Schema<IProperty>(
  {
    ...
    submittedBy: { type: String },   // ← seller/admin who created this listing
...
PropertySchema.index({ submittedBy: 1 });   // ← for seller "my listings" queries
