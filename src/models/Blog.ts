...
export interface IBlog extends Document {
  ...
  views: number;
  // ── Level structure ──────────────────────────────────────────
  areaSlug: string;        // e.g. "scheme-33"
  areaLabel: string;       // e.g. "Scheme 33"
  schemeSlug: string;      // e.g. "dha-karachi"
  schemeLabel: string;     // e.g. "DHA Karachi"
  // ── SEO ──────────────────────────────────────────────────────
  metaTitle: string;
...
const BlogSchema = new Schema<IBlog>(
  {
    ...
    // area / scheme — optional, empty string means "none assigned"
